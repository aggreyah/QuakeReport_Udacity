...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject myStringJsonObject = new JSONObject(SAMPLE_JSON_RESPONSE);
            //Extract “features” JSONArray
            JSONArray myJSONArray = myStringJsonObject.getJSONArray("features");
            //Loop through each feature in the array
            for (int i = 0; i < myJSONArray.length(); i++){
                //Get earthquake JSONObject at position i
                JSONObject earthquakeFeatures = myJSONArray.getJSONObject(i);
                //Get “properties” JSONObject
                JSONObject currentEartquakeProperties = earthquakeFeatures.getJSONObject("properties");
                //Extract “mag” for magnitude
                double currentMagnitude = currentEartquakeProperties.getDouble("mag");
                //Extract “place” for location
                String currentLocation = currentEartquakeProperties.getString("place");
                //Extract “time” for time
                Long currentTime = currentEartquakeProperties.getLong("time");
                //Extract "url" for the details url
                String currentUrl = currentEartquakeProperties.getString("url");

                /**
                 * Create Earthquake java object from magnitude, location, and time
                 * Add earthquake to list of earthquakes*/
                earthquakes.add(new Earthquake(currentMagnitude, currentLocation, currentTime, currentUrl));
            }
